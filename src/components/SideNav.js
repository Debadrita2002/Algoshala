  ...
  return (
    <div className='nav-container'>
        ...
        <div className='menu-container'>
          ...
          <Link to='/dashboard/payment-history' className={location.pathname === '/dashboard/payment-history'?'menu-active-link':'menu-link'}><i class="fa-solid fa-list"></i> Payment History</Link>
        </div>
        <div className='contact-us'>
          <p><i class="fa-solid fa-address-book"></i> Contact Developer</p>
          <p><i class="fa-brands fa-whatsapp"></i> 3456789678</p>
        </div>
    </div>
  )
}
